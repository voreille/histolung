...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler("superpixel_segmentation.log",
                            mode="w")  # Logs to file
    ],
)
...
if __name__ == "__main__":
    ...
    data_paths = {
        "cptac_luad": {
            ...
            "output_dir": output_dir / "cptac_luad",
        },
        "cptac_lusc": {
            "raw_data": cptac_path,
            "mask_dir": masks_path / "cptac_lusc",
            "output_dir": output_dir / "cptac_lusc",
        },
        "tcga_luad": {
            "raw_data": tcga_path,
            "mask_dir": masks_path / "tcga_luad",
            "output_dir": output_dir / "tcga_luad",
        },
        "tcga_lusc": {
            "raw_data": tcga_path,
            "mask_dir": masks_path / "tcga_lusc",
            "output_dir": output_dir / "tcga_lusc",
        }
    }
    ...
    for key, paths in data_paths.items():
        logger.info(f"Running segmentation for {key} dataset...")
        superpixel_segmentation(
            raw_data_dir=paths["raw_data"],
            masks_dir=paths["mask_dir"],
